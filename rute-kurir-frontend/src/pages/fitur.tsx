...
export default function Fitur() {
  ...
  return (
    <section
      id="fitur"
      ref={fiturRef}
      className="pt-[100px] w-full min-h-screen px-10 mt-5 pb-20"
    >
      <h1
      ...
      <p
        className={`text-gray-600 text-center text-xl mt-4 max-w-3xl mx-auto transition-all duration-700 ease-out transform delay-150 ${animation}`}
      >
      ...
      <div
        className={`grid grid-cols-1 md:grid-cols-3 gap-10 mt-16 mx-auto max-w-7xl transition-all duration-700 ease-out transform delay-300 ${animation}`}
      >
        {/* Card 1 */}
        <div className="bg-white p-10 rounded-xl shadow-md text-center transition-all duration-300 transform hover:scale-105 hover:shadow-xl">
      ...
      {/* Cara Kerja Sistem */}
<div
  className={`w-full py-14 bg-gradient-to-b from-[#f4f8ff] to-[#f4f8ff] mt-28 transition-all duration-700 ease-out transform delay-500 ${animation}`}
>
  <h1 className="text-5xl font-bold text-center">
    Cara Kerja Sistem
  </h1>

  <p className="text-gray-600 text-center text-xl mt-6 max-w-3xl mx-auto">
    Proses sederhana dalam 3 langkah untuk mengoptimalkan rute pengiriman Anda
  </p>

  <div className="grid grid-cols-1 md:grid-cols-3 gap-20 mt-24 max-w-8xl w-full mx-auto text-center px-6 pb-14">
    
    {/* Step 1 */}
    <div className="flex flex-col items-center">
      <div className="w-20 h-20 rounded-full bg-red-600 flex items-center justify-center shadow-lg">
        <Icon icon="mynaui:upload-solid" className="text-white text-5xl" />
      </div>
      <h2 className="text-2xl font-bold mt-7">1. Upload Alamat</h2>
    ...
    {/* Step 2 */}
    <div className="flex flex-col items-center">
      <div className="w-20 h-20 rounded-full bg-blue-600 to-red-500 flex items-center justify-center shadow-lg">
        <Icon icon="material-symbols:route" className="text-white text-5xl" />
      </div>
      <h2 className="text-2xl font-bold mt-7">2. Optimasi Otomatis</h2>
      <p className="text-gray-600 mt-4 text-lg max-w-sm">
    ...
    {/* Step 3 */}
    <div className="flex flex-col items-center">
      <div className="w-20 h-20 rounded-full bg-gradient-to-br from-red-500 to-blue-600 flex items-center justify-center shadow-lg">
        <Icon icon="mdi:truck-delivery-outline" className="text-white text-5xl" />
      </div>
      <h2 className="text-2xl font-bold mt-7">3. Mulai Pengiriman</h2>
      <p className="text-gray-600 mt-4 text-lg max-w-sm">
